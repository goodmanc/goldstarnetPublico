...
$label = 'Fieldbook';
$labelPlural = 'Fieldbooks';
$this->breadcrumbs=array(
	'Fieldbook'=>array('index'),
	'Administración',
);
$controllerID = $this->id;
$this->menu=array(
array('label'=>'Listar Fieldbook', 'icon' => '<i class="fa fa-list-alt"></i>', 'url'=>array('index')),
array('label'=>'Crear Fieldbook', 'icon' => '<i class="fa fa-plus-square-o"></i>', 'url'=>array('create')),
);
...
$('#fieldbook-grid').yiiGridView('update', {
data: $(this).serialize()
});
return false;
});
