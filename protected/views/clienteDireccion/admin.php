...
$labelPlural = 'Cliente Direccions';
$this->breadcrumbs=array(
	'Cliente Direccion'=>array('index'),
	'Administración',
);

$this->menu=array(
array('label'=>'Listar ClienteDireccion', 'icon' => '<i class="fa fa-list-alt"></i>', 'url'=>array('index')),
array('label'=>'Crear ClienteDireccion', 'icon' => '<i class="fa fa-plus-square-o"></i>', 'url'=>array('create')),
);
...
$('#cliente-direccion-grid').yiiGridView('update', {
data: $(this).serialize()
});
return false;
});
...
<?php $controllerID = $this->id;
    ...
    array(
		...
		array(
			'name'=>'cliente_id',
			'filter'=>CHtml::listData(Familia::model()->findAll(), 'id', 'subNumCat'),
			'value'=>'$data->cliente->subNumCat'),
		'code',
		'calle',
		'poblacion',
		'ciudad',
...
<script>
    ...
    var label ='Cliente Direccion';
    var labelPlural ='Cliente Direccions';
