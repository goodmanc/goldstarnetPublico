...
$label = 'Planta Area';
$labelPlural = 'Planta Areas';
$this->breadcrumbs=array(
	'Planta Area'=>array('index'),
	'Administración',
);

$this->menu=array(
array('label'=>'Listar PlantaArea', 'icon' => '<i class="fa fa-list-alt"></i>', 'url'=>array('index')),
array('label'=>'Crear PlantaArea', 'icon' => '<i class="fa fa-plus-square-o"></i>', 'url'=>array('create')),
);
...
$('#planta-area-grid').yiiGridView('update', {
data: $(this).serialize()
});
return false;
});
...
<script>
    ...
    var label ='Planta Area';
    var labelPlural ='Planta Areas';
