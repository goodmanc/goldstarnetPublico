...
$this->menu=array(
array('label'=>'Listar FbDato', 'icon' => '<i class="fa fa-list-alt"></i>', 'url'=>array('index')),
array('label'=>'Crear FbDato', 'icon' => '<i class="fa fa-plus-square-o"></i>', 'url'=>array('create')),
);
...
$('#fb-dato-grid').yiiGridView('update', {
data: $(this).serialize()
});
return false;
});
