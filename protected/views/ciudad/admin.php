...
$this->menu=array(
array('label'=>'Listar Ciudad', 'icon' => '<i class="fa fa-list-alt"></i>', 'url'=>array('index')),
array('label'=>'Crear Ciudad', 'icon' => '<i class="fa fa-plus-square-o"></i>', 'url'=>array('create')),
);
