...
$label = 'Proceso Plantilla';
$labelPlural = 'Proceso Plantillas';
$this->breadcrumbs=array(
	'Proceso Plantilla'=>array('index'),
	'Administración',
);

$this->menu=array(
array('label'=>'Listar ProcesoPlantilla', 'icon' => '<i class="fa fa-list-alt"></i>', 'url'=>array('index')),
array('label'=>'Crear ProcesoPlantilla', 'icon' => '<i class="fa fa-plus-square-o"></i>', 'url'=>array('create')),
);
...
$('#proceso-plantilla-grid').yiiGridView('update', {
data: $(this).serialize()
});
return false;
});
...
<script>
    ...
    var label ='Proceso Plantilla';
    var labelPlural ='Proceso Plantillas';
