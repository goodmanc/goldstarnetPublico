...
$this->menu=array(
array('label'=>'Listar Variedad', 'icon' => '<i class="fa fa-list-alt"></i>', 'url'=>array('index')),
array('label'=>'Crear Variedad', 'icon' => '<i class="fa fa-plus-square-o"></i>', 'url'=>array('create')),
);
...
$('#variedad-grid').yiiGridView('update', {
data: $(this).serialize()
});
return false;
});
