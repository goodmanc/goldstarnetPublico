...
<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('variedad_id')); ?>:</b>
	<?php echo CHtml::encode($data->variedad_id); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('substitute')); ?>:</b>
	<?php echo CHtml::encode($data->substitute); ?>
	<br />
