...
$label = 'Fb Reporte';
$labelPlural = 'Fb Reportes';
$this->breadcrumbs=array(
	'Fb Reporte'=>array('index'),
	'Administración',
);

$this->menu=array(
array('label'=>'Listar FbReporte', 'icon' => '<i class="fa fa-list-alt"></i>', 'url'=>array('index')),
array('label'=>'Crear FbReporte', 'icon' => '<i class="fa fa-plus-square-o"></i>', 'url'=>array('create')),
);
...
$('#fb-reporte-grid').yiiGridView('update', {
data: $(this).serialize()
});
return false;
});
...
<script>
    ...
    var label ='Fb Reporte';
    var labelPlural ='Fb Reportes';
