...
$label = 'Lote Historico';
$labelPlural = 'Lote Historicos';
$this->breadcrumbs=array(
	'Lote Historico'=>array('index'),
	'Administración',
);

$this->menu=array(
array('label'=>'Listar LoteHistorico', 'icon' => '<i class="fa fa-list-alt"></i>', 'url'=>array('index')),
array('label'=>'Crear LoteHistorico', 'icon' => '<i class="fa fa-plus-square-o"></i>', 'url'=>array('create')),
);
...
$('#lote-historico-grid').yiiGridView('update', {
data: $(this).serialize()
});
return false;
});
...
<script>
    ...
    var label ='Lote Historico';
    var labelPlural ='Lote Historicos';
