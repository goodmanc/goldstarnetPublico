...
$label = 'Bulto Reservado';
$labelPlural = 'Bulto Reservados';
$this->breadcrumbs=array(
	'Bulto Reservado'=>array('index'),
	'Administración',
);

$this->menu=array(
array('label'=>'Listar BultoReservado', 'icon' => '<i class="fa fa-list-alt"></i>', 'url'=>array('index')),
array('label'=>'Crear BultoReservado', 'icon' => '<i class="fa fa-plus-square-o"></i>', 'url'=>array('create')),
);
...
$('#bulto-reservado-grid').yiiGridView('update', {
data: $(this).serialize()
});
return false;
});
...
<script>
    ...
    var label ='Bulto Reservado';
    var labelPlural ='Bulto Reservados';
