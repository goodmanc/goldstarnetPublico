...
$this->menu=array(
array('label'=>'Listar Bulto', 'icon' => '<i class="fa fa-list-alt"></i>', 'url'=>array('index')),
array('label'=>'Crear Bulto', 'icon' => '<i class="fa fa-plus-square-o"></i>', 'url'=>array('create')),
);
