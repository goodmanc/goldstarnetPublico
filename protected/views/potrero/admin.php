...
$this->menu=array(
array('label'=>'Listar Potrero', 'icon' => '<i class="fa fa-list-alt"></i>', 'url'=>array('index')),
array('label'=>'Crear Potrero', 'icon' => '<i class="fa fa-plus-square-o"></i>', 'url'=>array('create')),
);
...
$('#potrero-grid').yiiGridView('update', {
data: $(this).serialize()
});
return false;
});
...
<?php $controllerID = $this->id;
    ...
    array(
		...
		'modified',
		array(
			'name'=>'contratoAgricultor_id',
			'filter'=>CHtml::listData(Familia::model()->findAll(), 'id', 'nombre'),
			'value'=>'$data->contratoagricultor->nombre'),
		*/
),
)); ?>
                        </div>
