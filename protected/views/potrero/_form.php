                ...
                <div class="ibox-content">
                    <div class="row">
                		...
                		<?php echo $form->error($model,'status'); ?>
                          ...
                          <div>
                                <?php echo $form->dropDownListRow($model, 'contratoAgricultor_id', CHtml::listData(Contratoagricultor::model()->findAll(), 'id', Contratoagricultor::representingColumn())); ?>
                		<?php echo $form->error($model,'contratoAgricultor_id'); ?>
                            </div>
