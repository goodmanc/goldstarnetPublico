...
$this->menu=array(
array('label'=>'Listar Planta', 'icon' => '<i class="fa fa-list-alt"></i>', 'url'=>array('index')),
array('label'=>'Crear Planta', 'icon' => '<i class="fa fa-plus-square-o"></i>', 'url'=>array('create')),
);
