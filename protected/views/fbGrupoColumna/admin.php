...
$label = 'Fb Grupo Columna';
$labelPlural = 'Fb Grupo Columnas';
$this->breadcrumbs=array(
	'Fb Grupo Columna'=>array('index'),
	'Administración',
);

$this->menu=array(
array('label'=>'Listar FbGrupoColumna', 'icon' => '<i class="fa fa-list-alt"></i>', 'url'=>array('index')),
array('label'=>'Crear FbGrupoColumna', 'icon' => '<i class="fa fa-plus-square-o"></i>', 'url'=>array('create')),
);
...
$('#fb-grupo-columna-grid').yiiGridView('update', {
data: $(this).serialize()
});
return false;
});
...
<script>
    ...
    var label ='Fb Grupo Columna';
    var labelPlural ='Fb Grupo Columnas';
