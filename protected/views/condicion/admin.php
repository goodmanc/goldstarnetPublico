...
$label = 'Condicion';
$labelPlural = 'Condicions';
$this->breadcrumbs=array(
	'Condicion'=>array('index'),
	'Administración',
);
$controllerID = $this->id;
$this->menu=array(
array('label'=>'Listar Condicion', 'icon' => '<i class="fa fa-list-alt"></i>', 'url'=>array('index')),
array('label'=>'Crear Condicion', 'icon' => '<i class="fa fa-plus-square-o"></i>', 'url'=>array('create')),
);
