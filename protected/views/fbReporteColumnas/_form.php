                ...
                <div class="ibox-content">
                    <div class="row">
                        <div class="col-sm-6 b-r">
                          ...
                          <div>
                                <?php echo $form->dropDownListRow($model, 'fbReporte_id', CHtml::listData(Fbreporte::model()->findAll(), 'id', Fbreporte::representingColumn())); ?>
                		<?php echo $form->error($model,'fbReporte_id'); ?>
                            </div>

                          <div>
                                <?php echo $form->dropDownListRow($model, 'fbColAsignada_id', CHtml::listData(Fbcolasignada::model()->findAll(), 'id', Fbcolasignada::representingColumn())); ?>
                		<?php echo $form->error($model,'fbColAsignada_id'); ?>
                            </div>
