...
$this->menu=array(
	array('label'=>'Listar Moneda', 'icon' => '<i class="fa fa-list-alt"></i>', 'url'=>array('index')),
	array('label'=>'Crear Moneda', 'icon' => '<i class="fa fa-plus-square-o"></i>', 'url'=>'javascript:create();'),
);
