...
$label = 'Bulto Historico';
$labelPlural = 'Bulto Historicos';
$this->breadcrumbs=array(
	'Bulto Historico'=>array('index'),
	'Administración',
);

$this->menu=array(
array('label'=>'Listar BultoHistorico', 'icon' => '<i class="fa fa-list-alt"></i>', 'url'=>array('index')),
array('label'=>'Crear BultoHistorico', 'icon' => '<i class="fa fa-plus-square-o"></i>', 'url'=>array('create')),
);
...
$('#bulto-historico-grid').yiiGridView('update', {
data: $(this).serialize()
});
return false;
});
...
<script>
    ...
    var label ='Bulto Historico';
    var labelPlural ='Bulto Historicos';
