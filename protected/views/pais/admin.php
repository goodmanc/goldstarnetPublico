...
$this->menu=array(
array('label'=>'Listar Pais', 'icon' => '<i class="fa fa-list-alt"></i>', 'url'=>array('index')),
array('label'=>'Crear Pais', 'icon' => '<i class="fa fa-plus-square-o"></i>', 'url'=>array('create')),
);
