...
$label = 'Lote Operacion';
$labelPlural = 'Lote Operacions';
$this->breadcrumbs=array(
	'Lote Operacion'=>array('index'),
	'Administración',
);

$this->menu=array(
array('label'=>'Listar LoteOperacion', 'icon' => '<i class="fa fa-list-alt"></i>', 'url'=>array('index')),
array('label'=>'Crear LoteOperacion', 'icon' => '<i class="fa fa-plus-square-o"></i>', 'url'=>array('create')),
);
...
$('#lote-operacion-grid').yiiGridView('update', {
data: $(this).serialize()
});
return false;
});
...
<script>
    ...
    var label ='Lote Operacion';
    var labelPlural ='Lote Operacions';
