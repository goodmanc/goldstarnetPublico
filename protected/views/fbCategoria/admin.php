...
$label = 'Fb Categoria';
$labelPlural = 'Fb Categorias';
$this->breadcrumbs=array(
	'Fb Categoria'=>array('index'),
	'Administración',
);

$this->menu=array(
array('label'=>'Listar FbCategoria', 'icon' => '<i class="fa fa-list-alt"></i>', 'url'=>array('index')),
array('label'=>'Crear FbCategoria', 'icon' => '<i class="fa fa-plus-square-o"></i>', 'url'=>array('create')),
);
...
$('#fb-categoria-grid').yiiGridView('update', {
data: $(this).serialize()
});
return false;
});
...
<script>
    ...
    var label ='Fb Categoria';
    var labelPlural ='Fb Categorias';
