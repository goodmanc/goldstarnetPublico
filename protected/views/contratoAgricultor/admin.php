...
$label = 'Contrato Agricultor';
$labelPlural = 'Contrato Agricultors';
$this->breadcrumbs=array(
	'Contrato Agricultor'=>array('index'),
	'Administración',
);
$controllerID = $this->id;
$this->menu=array(
array('label'=>'Listar ContratoAgricultor', 'icon' => '<i class="fa fa-list-alt"></i>', 'url'=>array('index')),
array('label'=>'Crear ContratoAgricultor', 'icon' => '<i class="fa fa-plus-square-o"></i>', 'url'=>array('create')),
);
...
$('#contrato-agricultor-grid').yiiGridView('update', {
data: $(this).serialize()
});
return false;
});
