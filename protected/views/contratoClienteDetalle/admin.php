...
$label = 'Contrato Cliente Detalle';
$labelPlural = 'Contrato Cliente Detalles';
...
<?php $controllerID = $this->id;
    ...
    array(
		...
		array(
			'name'=>'catalogo_id',
			'filter'=>CHtml::listData(Familia::model()->findAll(), 'id', 'substitute'),
			'value'=>'$data->catalogo->substitute'),
		'subNumCat',
		'nombreVariedad',
		'nombreExportacion',
		/*
