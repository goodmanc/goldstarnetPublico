...
class FbGrupoColumnaController extends AweController
{
	/**
...
//			'postOnly + delete', // we only allow deletion via POST request
	...
	{
		$model=new FbGrupoColumna;

		// Uncomment the following line if AJAX validation is needed
		// $this->performAjaxValidation($model);

		if(isset($_POST['FbGrupoColumna']))
		{
	 ...
	 * @return FbGrupoColumna the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=FbGrupoColumna::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param FbGrupoColumna $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='fb-grupo-columna-form')
		{
