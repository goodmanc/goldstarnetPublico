 ...
 * @property Especie[] $especies1
 * @property Especie[] $especies2
...
abstract class BaseUsers extends AweActiveRecord {
    ...
    public function rules() {
        return array(
            array(	'username, password, email, create_at',
					'required',
					'message' => Yii::t('app', 'Field is required')
			),
            array(	'superuser, status',
					'numerical',
					'integerOnly'=>true
			),
            array(	'username',
            ...
            array('activkey, lastvisit_at, superuser, status',
					'default',
					'setOnEmpty' => true,
					'value' => null
			),
    ...
    public function relations() {
        return array(
            'especies' => array(self::HAS_MANY, 'Especie', 'created_by'),
            'especies1' => array(self::HAS_MANY, 'Especie', 'modified_by'),
            'especies2' => array(self::HAS_MANY, 'Especie', 'used_by'),
