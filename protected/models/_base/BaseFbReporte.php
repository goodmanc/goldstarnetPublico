...
/**
 * This is the model base class for the table "fbreporte".
 * DO NOT MODIFY THIS FILE! It is automatically generated by AweCrud.
 * If any changes are necessary, you must set or override the required
 * property or method in class "FbReporte".
 *
 * Columns in table "fbreporte" available as properties of the model,
 * followed by relations of table "fbreporte" available as properties of the model.
 *
 * @property integer $id
 ...
 */
abstract class BaseFbReporte extends AweActiveRecord {
    ...
    public function rules() {
        return array(
            array(	'temporada_id, nombre',
					'required',
					'message' => Yii::t('app', 'Field is required')
			),
            array(	'temporada_id, used_by, created_by, modified_by',
					'numerical',
					'integerOnly'=>true
			),
            array(	'nombre',
            ...
            array('id, temporada_id, nombre, status, used_by, check_in, created_by, created, modified_by, modified', 'safe', 'on'=>'search'),
        );
    }
    ...
    public function relations() {
        return array(
            ...
            'fbreportecolumnases' => array(self::HAS_MANY, 'Fbreportecolumnas', 'fbReporte_id'),
        );
    }
