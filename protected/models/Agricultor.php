 ...
 *
 * The followings are the available columns in table 'agricultor':
 * @property integer $id
 * @property string $rut
 ...
 */
class Agricultor extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('rut, razonSocial, direccion', 'required'),
			...
			array('razonSocial, direccion', 'length', 'max'=>100),
	 ...
	 * @return Agricultor the static model class
	 */
